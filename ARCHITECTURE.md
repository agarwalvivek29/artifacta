...
| ---------- | --------------------------------------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| Artifact   | `packages/schema/proto/artifacta/v1/artifact.proto` | slug, owner_sub, owner_email, visibility, content_type | visibility: PRIVATE→INVITED→ORG→LINK (owner-set; LINK = no-login, VPN-gated, ADR-0018). owner_email is denormalized search metadata (ADR-0025), never used by CanView | audit: PUBLISH / VIEW |
